  ...
  return (
    <div className="flex min-h-screen bg-[#F7F7F5] overflow-x-hidden">
      ...
      <aside className="hidden md:flex md:w-64 bg-[#FBFBFA] border-r border-stone-200 flex-col flex-shrink-0 min-h-screen">
        {/* Brand Header */}
        <div className="h-16 px-6 flex items-center gap-3 border-b border-stone-200">
          <div className="w-8 h-8 rounded-lg bg-teal-800 flex items-center justify-center text-white shadow-xs">
            <GraduationCap className="w-4 h-4" />
          </div>
          <div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 pl-2 sm:pl-3 border-l border-stone-200">
              ...
              <div className="hidden sm:block text-left">
                <div className="text-xs font-medium text-stone-800">Demo Student</div>
                <div className="text-[10px] text-stone-400 font-mono">user_id: 1 (Demo)</div>
              </div>
            </div>
          </div>
        </header>
